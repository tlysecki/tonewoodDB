...
const woods = [
  new WoodType('Sitka Spruce',true,false,'Picea Sitchensis','510','Sitka Spruce is the single most common top wood for acoustics, and its dominance is well-earned. It has proven to be stiff, light, and strong in its fundamental tone. It does take longer to break in, so a brand new guitar may sound a bit sterile. Martin, Taylor, Yamaha all commonly use it for steel-string acoustics, as well as some of the best luthiers. It can be figured; bearclaw Sitka is an eye-catching wood. Sitka Spruce is widely available in North America.'),
