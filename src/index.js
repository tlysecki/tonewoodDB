...
const woods = [
  ...
  new WoodType('Walnut',true,true,'Juglans regia or nigra','1010','Often thought of as a tonal middle ground between rosewood and mahogany, walnut has many faces - straight-grained, curly, burled, purple, brown, black, and orange. Increasingly common are acoustics with walnut tops. Its lows are strong and present, but, being that it is not as reflective as denser woods, it keeps some warmth to its tone. As such, guitars with walnut make a good choice for almost any style.'),
